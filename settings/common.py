# -*- coding: utf-8 -*-
'''Django settings for uDisplay project.
...
APPS_DIR = ROOT_DIR.path('udisplay')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'udisplay.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    "EXCEPTION_HANDLER": "udisplay.base.exceptions.exception_handler",
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
# Tornado Config
TORNADO_PORT = env.int('TornadoPort', 9988)
SOCKET_PATH = env.str('SocketPath', '/socket')
...
DATABASES = {
    'default': env.db("DATABASE_URL", default="postgres://dev:password@localhost/udisplay"),
}
